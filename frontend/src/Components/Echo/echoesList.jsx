        ...
        <div className="mt-14 pb-20"> {/* Margin top and bottom */}
            <div className="container mx-auto"> {/* Center container */}
                <div className="text-center mb-10 max-w-[600px] mx-auto"> {/* Center text and set max width */}
                    <p data-aos='fade-up' className="text-sm justify-center">Newest Echoes</p> {/* Subtitle */}
                    <h1 data-aos='fade-up' className="text-3xl font-bold">Echoes</h1> {/* Title */}
                </div>
...
export default EchoesList // Export EchoesList component